...
public class UsersDao {
	...
	public boolean isExist(String id) {
		//아이디가 이미 존재하는지 여부를 담을 지역변수를 선언하고 초기값 지정
	...
	//인자로 전달된 아이디에 해당하는 가입정보를 삭제하는 메소드 (delete)
	...
	//인자로 전달된 아이디에 해당되는 가입정보를 리턴해주는 메소드 (select)
	...
	//인자로 전달된 정보가 유효한 정보인지 여부를 리턴하는 메소드 (select)
	public boolean isValid(UsersDto dto) {
		
		//아이디 비밀번호가 유효한 정보인지 여부를 담을 지역변수를 만들고, 초기값을 부여
