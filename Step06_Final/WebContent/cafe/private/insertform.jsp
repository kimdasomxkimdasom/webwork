...
<title>/cafe/private/inserform.jsp</title>
<style>
	#content{
		width: 100%
...
<nav>
	<ul class="breadcrumb">
		...
		<li class="breadcrumb-item">
			<a href="${pageContext.request.contextPath }/cafe/list.jsp">Post List</a>
		</li>
...
<div class="container">
		...
		<form action="insert.jsp" method="post">
			...
			<div class="form-group">
				...
				<!-- textarea의 id는 content로 해야한다. (스마트에디터를 사용할거면)  -->
				<textarea class="form-control" name="content" id="content" ></textarea>
			</div>
			<button class="btn btn-dark" type="submit" onclick="submitContents(this);">저장하기</button>
		</form>
</div>
