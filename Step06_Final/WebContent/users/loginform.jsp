...
<form class="form-signin" action="login.jsp" method="post">
	...
	<input type="text" id="id" name="id" class="form-control" 
		placeholder="아이디입력..." value="<%=savedId %>" required autofocus>
	...
	<input type="password" name="pwd" id="pwd" class="form-control" 
  	...
  	<a class="btn btn-lg btn-warning btn-block" 
				href="${pageContext.request.contextPath}/users/signup_form.jsp">Sing up</a>
  	<p class="mt-5 mb-3 text-muted">&copy;by.bootstrap</p>
</form>
</body>
</html>