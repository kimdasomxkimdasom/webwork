...
<div class="container">
	<h1>Photo Gallery
		...
		<a class="btn btn-secondary btn-sm"  href="list.jsp">
		Photo Gallery(paging)</a>
	</h1>
	<br />
...
<script>
	...
	//페이지가 처음 로딩될때 1page를 보여주기 때문에 초기값을 1로 지정한다.
	let currentPage=1; //화면상 로딩된 최신페이지번호를 저장할 변수
